...
typedef struct
{
	...
	USART_HandleTypeDef *port; //HAL Serial Port handler
...
void MODBUS_LWIP_ReceiveTaskProceed(void *argument);
void MODBUS_W5500_ReceiveTaskProceed(void *argument);
